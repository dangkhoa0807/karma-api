...
function addToCart(x) {
  const parent = x.parentElement.parentElement.parentElement.parentElement;
  let qty = parseInt(parent.querySelector("#sst").value);
  let imgProduct = parent.children[0].src;
  ...
  if (hadProduct) {
    ...
    if (!imgProduct) {
      imgProduct = parent.children[0].children[0].children[0].children[0].src;
    }
    const price = parent.querySelector(".price_sales").innerText;
    const nameProduct = parent.querySelector(".name").innerText;
    ...
    storedCartState.forEach((product) => {
      html += `<tr class="product">
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="${product.imgProduct}" style="width: 200px;" alt="">
                                        </div>
                                ...
                                <td>
                                    <h5 class="total">72000</h5>
                                </td>
                                <td><button href="#" class="btn btn-black close delete" data-id="${product.id}">x</button></td>
                            </tr>
                                    `;
